 ...
 * Use the {@link unlimiteddaily#newInstance} factory method to
...
public class unlimiteddaily extends Fragment implements ClickListner {
  ...
  private RecyclerView mRecyclerView;
   ...
   /* @Override
    ...
    public static unlimiteddaily newInstance(String param1, String param2) {
        unlimiteddaily fragment = new unlimiteddaily();
