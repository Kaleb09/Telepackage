 ...
 * Use the {@link internetandvoicemonthly#newInstance} factory method to
 * create an instance of this fragment.
 */
public class internetandvoicemonthly extends Fragment implements ClickListner {
    TextView t;
  ...
  private RecyclerView mRecyclerView;
   ...
   /* @Override
    ...
    public internetandvoicemonthly() {
    ...
    public static internetandvoicemonthly newInstance(String param1, String param2) {
        internetandvoicemonthly fragment = new internetandvoicemonthly();
